//
//  CornellDiningHallsListView.swift
//  ColumbiaCals
//
//  Dining halls list view for Cornell University
//

import SwiftUI

struct CornellDiningHallsListView: View {
    @Binding var showUniversitySidebar: Bool
    
    @StateObject private var cartVM = CartViewModel()
    @StateObject private var networkManager = CornellNetworkManager()
    ...
    var body: some View {
        NavigationView {
                ...
                if diningHalls.isEmpty {
                    ...
                    ScrollView {
                        VStack(spacing: 20) {
                                ...
                                VStack(spacing: 16) {
                                    ...
                                    HStack(spacing: 12) {
                                        StatCard(
                                            ...
                                            value: "\(diningHalls.filter { $0.isCurrentlyServing }.count)",
                                            label: "Open Now",
                                            color: .accentGreen
                                        )
                            ...
                            .frame(height: 200)
                            .shadow(color: Color.cornellRed.opacity(0.3), radius: 16, x: 0, y: 8)
                            ...
                            // Section: Open Now
                            if !diningHalls.filter({ $0.isCurrentlyServing }).isEmpty {
                                VStack(alignment: .leading, spacing: 0) {
                                    ...
                                    VStack(spacing: 12) {
                                        ForEach(diningHalls.filter { $0.isCurrentlyServing }, id: \.self.name) { hall in
                                            NavigationLink(destination: CornellDiningHallDetailView(diningHall: hall, cartVM: cartVM)) {
                                                DiningHallCard(diningHall: hall, university: "cornell")
                                            }
            ...
            .navigationTitle("Cornell University")
            ...
            .onAppear {
                ...
                ratingService.fetchRatingAverages(university: "cornell")
            }
        }
    }
}
...
#Preview {
    CornellDiningHallsListView(showUniversitySidebar: .constant(false))
}
